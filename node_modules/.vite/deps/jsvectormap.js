...
var require_jsvectormap_min = __commonJS({
  "node_modules/jsvectormap/dist/js/jsvectormap.min.js"(exports, module) {
    !function(t, e) {
      ...
      var o = function(e2, a2, n2) {
      ...
      }, f = {}, m = 1, g = { on: function(t2, e2, i2, s2) {
        void 0 === s2 && (s2 = {});
        var a2 = "jvm:" + e2 + "::" + m++;
        f[a2] = { selector: t2, handler: i2 }, i2._uid = a2, t2.addEventListener(e2, i2, s2);
      }, delegate: function(t2, e2, i2, s2) {
        (e2 = e2.split(" ")).forEach(function(e3) {
          g.on(t2, e3, function(t3) {
            var e4 = t3.target;
        ...
        var s2 = e2.split(":")[1];
        t2.removeEventListener(s2, i2), delete f[i2._uid];
      }, flush: function() {
        Object.keys(f).forEach(function(t2) {
          g.off(f[t2].selector, t2, f[t2].handler);
        });
      }, getEventRegistry: function() {
        return f;
      } };
      var v = { onViewportChange: "viewport:changed", onRegionClick: "region:clicked", onMarkerClick: "marker:clicked", onRegionSelected: "region:selected", onMarkerSelected: "marker:selected", onRegionTooltipShow: "region.tooltip:show", onMarkerTooltipShow: "marker.tooltip:show", onLoaded: "map:loaded", onDestroyed: "map:destroyed" };
      function y(t2, e2, i2) {
      ...
      function b(t2, e2) {
        t2.prototype = Object.create(e2.prototype), t2.prototype.constructor = t2, _(t2, e2);
      }
      function _(t2, e2) {
        return _ = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t3, e3) {
      ...
      function k(t2, e2) {
        ...
        if (Array.isArray(t2) || (i2 = function(t3, e3) {
          if (t3) {
            ...
            return "Object" === i3 && t3.constructor && (i3 = t3.constructor.name), "Map" === i3 || "Set" === i3 ? Array.from(t3) : "Arguments" === i3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i3) ? S(t3, e3) : void 0;
          }
      ...
      var x = function() {
        ...
        return t2.prototype.dispose = function() {
          ...
          for (var t3, e2 = k(Object.getOwnPropertyNames(this)); !(t3 = e2()).done; ) {
            this[t3.value] = null;
          }
        }, t2;
      }(), M = { getLabelText: function(t2, e2) {
        if (e2) {
        ...
        function e2(e3) {
          var i3, s2 = e3.map, a2 = e3.code, n2 = e3.path, r2 = e3.style, o2 = e3.label, h2 = e3.labelStyle, l2 = e3.labelsGroup;
          (i3 = t2.call(this) || this)._map = s2, i3.shape = i3._createRegion(n2, a2, r2);
          var c2 = i3.shape.getBBox(), u2 = i3.getLabelText(a2, o2);
          if (o2 && u2) {
            var p2 = i3.getLabelOffsets(a2, o2);
            i3.labelX = c2.x + c2.width / 2 + p2[0], i3.labelY = c2.y + c2.height / 2 + p2[1], i3.label = i3._map.canvas.createText({ text: u2, textAnchor: "middle", alignmentBaseline: "central", dataCode: a2, x: i3.labelX, y: i3.labelY }, h2, l2), i3.label.addClass("jvm-region jvm-element");
          }
          return i3;
        }
        b(e2, t2);
        var i2 = e2.prototype;
        return i2._createRegion = function(t3, e3, i3) {
          return (t3 = this._map.canvas.createPath({ d: t3, dataCode: e3 }, i3)).addClass("jvm-region jvm-element"), t3;
        }, i2.updateLabelPosition = function() {
      ...
      var C = function(t2) {
        function e2(e3) {
          var i2, s2 = e3.index, a2 = e3.map, n2 = e3.style, r2 = e3.x1, o2 = e3.y1, h2 = e3.x2, l2 = e3.y2, c2 = e3.group, u2 = e3.config;
          return (i2 = t2.call(this) || this).config = u2, i2.shape = a2.canvas.createLine({ x1: r2, y1: o2, x2: h2, y2: l2, dataIndex: s2 }, n2, c2), i2.shape.addClass("jvm-line"), i2;
        }
        return b(e2, t2), e2.prototype.setStyle = function(t3, e3) {
      ...
      var L = function(t2) {
        function e2(e3) {
          ...
          return (i3 = t2.call(this) || this)._map = h2, i3._isImage = !!a2.initial.image, i3.config = arguments[0], i3.shape = h2.canvas[i3._isImage ? "createImage" : "createCircle"]({ dataIndex: s2, cx: r2, cy: o2 }, a2, l2), i3.shape.addClass("jvm-marker jvm-element"), i3._isImage && i3.updateLabelPosition(), n2 && i3._createLabel(i3.config), i3;
        }
        b(e2, t2);
        var i2 = e2.prototype;
      ...
      var O = function() {
        ...
        function t2(t3, e3, i2) {
          void 0 === t3 && (t3 = {}), this._map = i2, this._elements = e3, this._values = t3.values || {}, this.config = t3, this.config.attribute = t3.attribute || "fill", t3.attributes && this.setAttributes(t3.attributes), "object" == typeof t3.scale && (this.scale = new A(t3.scale)), this.config.legend && (this.legend = new O(u({ map: this._map, series: this }, this.config.legend))), this.setValues(this._values);
        }
        var e2 = t2.prototype;
      ...
      var E = { _setupContainerEvents: function() {
        var t2, e2, i2 = this, s2 = false, a2 = this;
        this.params.draggable && (g.on(this.container, "mousemove", function(i3) {
          if (!s2)
            return false;
          a2.transX -= (t2 - i3.pageX) / a2.scale, a2.transY -= (e2 - i3.pageY) / a2.scale, a2._applyTransform(), t2 = i3.pageX, e2 = i3.pageY;
        }), g.on(this.container, "mousedown", function(i3) {
          return s2 = true, t2 = i3.pageX, e2 = i3.pageY, false;
        }), g.on(document.body, "mouseup", function() {
          s2 = false;
        })), this.params.zoomOnScroll && g.on(this.container, "wheel", function(t3) {
          var e3 = 0;
          ...
          a2.tooltip && a2.tooltip.hide(), a2._setScale(a2.scale * o2, n2, r2), t3.preventDefault();
        });
      }, _setupElementEvents: function() {
        var t2, e2, i2, s2 = this, a2 = this.container;
        g.on(a2, "mousemove", function(s3) {
          Math.abs(t2 - s3.pageX) + Math.abs(e2 - s3.pageY) > 2 && (i2 = true);
        }), g.delegate(a2, "mousedown", ".jvm-element", function(s3) {
          t2 = s3.pageX, e2 = s3.pageY, i2 = false;
        }), g.delegate(a2, "mouseover mouseout", ".jvm-element", function(t3) {
          var e3 = y(s2, this, true), i3 = s2.params.showTooltip;
          "mouseover" === t3.type ? (e3.element.hover(true), s2.tooltip.text(e3.tooltipText), s2._emit(e3.event, [t3, s2.tooltip, e3.code]), t3.defaultPrevented || i3 && s2.tooltip.show()) : (e3.element.hover(false), i3 && s2.tooltip.hide());
        }), g.delegate(a2, "mouseup", ".jvm-element", function(t3) {
          var e3 = y(s2, this);
        ...
        }), g.delegate(a2, "click", ".jvm-element", function(t3) {
          var e3 = y(s2, this), i3 = e3.type, a3 = e3.code;
          s2._emit("region" === i3 ? v.onRegionClick : v.onMarkerClick, [t3, a3]);
        });
        ...
        this.container.appendChild(i2), this.container.appendChild(s2), g.on(i2, "click", function() {
          t2._setScale(e2.scale * e2.params.zoomStep, e2.width / 2, e2.height / 2, false, e2.params.zoomAnimate);
        }), g.on(s2, "click", function() {
          t2._setScale(e2.scale / e2.params.zoomStep, e2.width / 2, e2.height / 2, false, e2.params.zoomAnimate);
        });
        ...
        var t2, e2, i2, s2, a2, n2, r2, o2 = this, h2 = function(h3) {
          ...
          if ("touchstart" == h3.type && (r2 = 0), 1 == d2.length)
            1 == r2 && (u2 = o2.transX, p2 = o2.transY, o2.transX -= (i2 - d2[0].pageX) / o2.scale, o2.transY -= (s2 - d2[0].pageY) / o2.scale, o2.tooltip.hide(), o2._applyTransform(), u2 == o2.transX && p2 == o2.transY || h3.preventDefault()), i2 = d2[0].pageX, s2 = d2[0].pageY;
          else if (2 == d2.length)
            if (2 == r2)
              c2 = Math.sqrt(Math.pow(d2[0].pageX - d2[1].pageX, 2) + Math.pow(d2[0].pageY - d2[1].pageY, 2)) / e2, o2._setScale(t2 * c2, a2, n2), o2.tooltip.hide(), h3.preventDefault();
            else {
        ...
        g.on(o2.container, "touchstart", h2), g.on(o2.container, "touchmove", h2);
      }, _createRegions: function() {
        var t2, e2;
        for (t2 in this._regionLabelsGroup = this._regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths)
          e2 = new j({ map: this, code: t2, path: this.mapData.paths[t2].path, style: u({}, this.params.regionStyle), labelStyle: this.params.regionLabelStyle, labelsGroup: this._regionLabelsGroup, label: this.params.labels && this.params.labels.regions }), this.regions[t2] = { config: this.mapData.paths[t2], element: e2 };
        ...
        for (var n2 in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t2) {
          ...
          false !== s2 && false !== a2 && (this.lines[p(r2.from, r2.to)] = new C({ index: n2, map: this, style: u({ initial: this.params.lineStyle }, { initial: r2.style || {} }, true), x1: s2.x, y1: s2.y, x2: a2.x, y2: a2.y, group: this.linesGroup, config: r2 }));
        }
      }, _createMarkers: function(t2, e2) {
        var i2, s2, a2, n2, r2 = this;
        for (var o2 in void 0 === t2 && (t2 = {}), void 0 === e2 && (e2 = false), this._markersGroup = this._markersGroup || this.canvas.createGroup("jvm-markers-group"), this._markerLabelsGroup = this._markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t2)
          if (i2 = t2[o2], a2 = this.getMarkerPosition(i2), n2 = i2.coords.join(":"), a2) {
            if (e2) {
            ...
            s2 = new L({ index: o2, map: this, style: u(this.params.markerStyle, { initial: i2.style || {} }, true), label: this.params.labels && this.params.labels.markers, labelsGroup: this._markerLabelsGroup, cx: a2.x, cy: a2.y, group: this._markersGroup, marker: i2, isRecentlyCreated: e2 }), this.markers[o2] && this.removeMarkers([o2]), this.markers[o2] = { _uid: n2, config: i2, element: s2 };
          }
        ...
        var n2, r2, o2, h2, l2, c2, u2, p2, d2, f2, m2 = this, g2 = 0, y2 = Math.abs(Math.round(60 * (t2 - this.scale) / Math.max(t2, this.scale)));
        t2 > this.params.zoomMax * this.baseScale ? t2 = this.params.zoomMax * this.baseScale : t2 < this.params.zoomMin * this.baseScale && (t2 = this.params.zoomMin * this.baseScale), void 0 !== e2 && void 0 !== i2 && (n2 = t2 / this.scale, s2 ? (d2 = e2 + this.defaultWidth * (this.width / (this.defaultWidth * t2)) / 2, f2 = i2 + this.defaultHeight * (this.height / (this.defaultHeight * t2)) / 2) : (d2 = this.transX - (n2 - 1) / t2 * e2, f2 = this.transY - (n2 - 1) / t2 * i2)), a2 && y2 > 0 ? (o2 = this.scale, h2 = (t2 - o2) / y2, l2 = this.transX * this.scale, u2 = this.transY * this.scale, c2 = (d2 * t2 - l2) / y2, p2 = (f2 * t2 - u2) / y2, r2 = setInterval(function() {
          g2 += 1, m2.scale = o2 + h2 * g2, m2.transX = (l2 + c2 * g2) / m2.scale, m2.transY = (u2 + p2 * g2) / m2.scale, m2._applyTransform(), g2 == y2 && (clearInterval(r2), m2._emit(v.onViewportChange, [m2.scale, m2.transX, m2.transY]));
        }, 10)) : (this.transX = d2, this.transY = f2, this.scale = t2, this._applyTransform(), this._emit(v.onViewportChange, [this.scale, this.transX, this.transY]));
        ...
        if (t2.region ? s2.push(t2.region) : t2.regions && (s2 = t2.regions), s2.length)
          ...
          }), this._setScale(Math.min(this.width / i2.width, this.height / i2.height), -(i2.x + i2.width / 2), -(i2.y + i2.height / 2), true, t2.animate);
        if (t2.coords) {
          var a2 = this.coordsToPoint(t2.coords[0], t2.coords[1]), n2 = this.transX - a2.x / this.scale, r2 = this.transY - a2.y / this.scale;
          return this._setScale(t2.scale * this.baseScale, n2, r2, true, t2.animate);
        }
      }, updateSize: function() {
        this.width = this.container.offsetWidth, this.height = this.container.offsetHeight, this._resize(), this.canvas.setSize(this.width, this.height), this._applyTransform();
      }, coordsToPoint: function(t2, e2) {
        var i2, s2, a2, n2 = V.maps[this.params.map].projection, r2 = n2.centralMeridian;
        return i2 = Y[n2.type](t2, e2, r2), !!(s2 = this.getInsetForPoint(i2.x, i2.y)) && (a2 = s2.bbox, i2.x = (i2.x - a2[0].x) / (a2[1].x - a2[0].x) * s2.width * this.scale, i2.y = (i2.y - a2[0].y) / (a2[1].y - a2[0].y) * s2.height * this.scale, { x: i2.x + this.transX * this.scale + s2.left * this.scale, y: i2.y + this.transY * this.scale + s2.top * this.scale });
        ...
        for (var i2 in this.lines) {
          ...
          false !== t2 && false !== e2 && this.lines[i2].setStyle({ x1: t2.x, y1: t2.y, x2: e2.x, y2: e2.y });
        }
        ...
        return b(e2, t2), e2.prototype.applyAttr = function(e3, i2) {
        ...
        function e2(e3) {
          var i3;
          return (i3 = t2.call(this, "svg") || this)._container = e3, i3._defsElement = new T("defs"), i3._rootElement = new T("g", { id: "jvm-regions-group" }), i3.node.appendChild(i3._defsElement.node), i3.node.appendChild(i3._rootElement.node), i3._container.appendChild(i3.node), i3;
        }
        b(e2, t2);
        var i2 = e2.prototype;
        ...
        function e2(e3) {
          var i3;
          i3 = t2.call(this) || this;
          var s2 = l("div", "jvm-tooltip");
          return i3._map = e3, i3._tooltip = document.body.appendChild(s2), i3._bindEventListeners(), w(i3) || w(i3);
        }
        b(e2, t2);
        var i2 = e2.prototype;
        return i2._bindEventListeners = function() {
          var t3 = this;
          g.on(this._map.container, "mousemove", function(e3) {
            if (t3._tooltip.classList.contains("active")) {
              var i3, s2, a2 = (i3 = t3._map.container, s2 = "#jvm-regions-group", Element.prototype.querySelector.call(i3, s2)).getBoundingClientRect(), n2 = t3._tooltip.getBoundingClientRect(), r2 = n2.height, o2 = n2.width, h2 = e3.clientY <= a2.top + r2 + 5, l2 = e3.pageY - r2 - 5, c2 = e3.pageX - o2 - 5;
              h2 && (l2 += r2 + 5, c2 -= 10), e3.clientX < a2.left + o2 + 5 && (c2 = e3.pageX + 5 + 2, h2 && (c2 += 10)), t3.css({ top: l2 + "px", left: c2 + "px" });
            }
          });
        }, i2.getElement = function() {
          return this._tooltip;
        }, i2.show = function() {
          this._tooltip.classList.add("active");
        }, i2.hide = function() {
          this._tooltip.classList.remove("active");
        }, i2.text = function(t3, e3) {
          void 0 === e3 && (e3 = false);
          var i3 = e3 ? "innerHTML" : "textContent";
          if (!t3)
            return this._tooltip[i3];
          this._tooltip[i3] = t3;
        }, i2.css = function(t3) {
          for (var e3 in t3)
            this._tooltip.style[e3] = t3[e3];
          return this;
        }, e2;
      }(x), H = function() {
        function t2(t3, e3) {
        ...
        return e2._init = function() {
          var t3 = this.params;
          this.container = h(t3.selector), this.container.classList.add("jvm-container"), this.canvas = new I(this.container), this.setBackgroundColor(t3.backgroundColor), this._createRegions(), this.updateSize(), this._createLines(t3.lines || {}, t3.markers || {}), this._createMarkers(t3.markers), this._repositionLabels(), this._setupContainerEvents(), this._setupElementEvents(), t3.zoomButtons && this._setupZoomButtons(), t3.showTooltip && (this.tooltip = new R(this)), t3.selectedRegions && this._setSelected("regions", t3.selectedRegions), t3.selectedMarkers && this._setSelected("markers", t3.selectedMarkers), t3.focusOn && this.setFocus(t3.focusOn), t3.visualizeData && (this.dataVisualization = new H(t3.visualizeData, this)), t3.bindTouchEvents && ("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch) && this._setupContainerTouchEvents(), t3.series && (this.container.appendChild(this.legendHorizontal = l("div", "jvm-series-container jvm-series-h")), this.container.appendChild(this.legendVertical = l("div", "jvm-series-container jvm-series-v")), this._createSeries()), this._emit(v.onLoaded, [this]);
        }, e2._emit = function(t3, e3) {
          for (var i2 in v)
            v[i2] === t3 && "function" == typeof this.params[i2] && this.params[i2].apply(this, e3);
          ...
          void 0 === i2 && (i2 = {}), console.warn("`addLine` method is deprecated, please use `addLines` instead."), this._createLines([{ from: t3, to: e3, style: i2 }], this.markers, true);
        }, e2.addLines = function(t3) {
          var e3 = this._getLinesAsUids();
          Array.isArray(t3) || (t3 = [t3]), this._createLines(t3.filter(function(t4) {
            return !(e3.indexOf(p(t4.from, t4.to)) > -1);
          }), this.markers, true);
        }, e2.removeLines = function(t3) {
          var e3 = this;
          (t3 = Array.isArray(t3) ? t3.map(function(t4) {
            return p(t4.from, t4.to);
          }) : this._getLinesAsUids()).forEach(function(t4) {
            e3.lines[t4].dispose(), delete e3.lines[t4];
          });
          ...
          var i2 = p(t3, e3);
          this.lines.hasOwnProperty(i2) && (this.lines[i2].element.remove(), delete this.lines[i2]);
        }, e2.reset = function() {
          ...
          var e3 = this;
          void 0 === t3 && (t3 = true), g.flush(), this.tooltip.dispose(), this._emit(v.onDestroyed), t3 && Object.keys(this).forEach(function(t4) {
            try {
              delete e3[t4];
            } catch (t5) {
            }
