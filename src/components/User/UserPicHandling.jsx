      ...
      <Modal show={show} onHide={handleClose} centered className="z-80">
        <Modal.Header closeButton>
          <div className="flex flex-wrap justify-center gap-4">
            <button
              className="rounded bg-purple-500 px-3 py-1.5 text-sm font-medium text-gray hover:bg-opacity-90"
              type="button"
              onClick={startCamera}
            >
              <CiCamera size={19} className="mb-1" />
            ...
            {cameraActive && (
              <>
                ...
                ></canvas>
                <button
                  className="rounded bg-yellow-500 px-3 py-1.5 text-sm font-medium text-gray hover:bg-opacity-90"
                  type="button"
                  onClick={closeCamera}
                >
                  <IoMdClose size={19} className="mb-1" />
            ...
            <button
              className="rounded bg-primary px-3 py-1.5 text-sm font-medium text-gray hover:bg-opacity-90"
              type="button"
              onClick={triggerProfilePictureUpload}
            >
              <MdOutlineDriveFolderUpload size={19} className="mb-1" />
            ...
            />
            <button
              className="rounded bg-success px-3 py-1.5 text-sm font-medium text-gray hover:bg-opacity-90"
              type="button"
              onClick={handleProfilePictureUpload}
              disabled={loading}
            >
              {loading ? "Uploading..." : <CiBookmark size={19} className="mb-1" />}
            </button>
            <button
              className="rounded bg-danger px-3 py-1.5 text-sm font-medium text-gray hover:bg-opacity-90"
              type="button"
              onClick={handleDeleteProfilePicture}
              disabled={loading}
            >
              {loading ? "Deleting..." : <IoTrashOutline size={19} className="mb-1" />}
            </button>
          </div>
        </Modal.Header>
        <Modal.Body></Modal.Body>
