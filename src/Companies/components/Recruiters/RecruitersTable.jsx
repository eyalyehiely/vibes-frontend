                ...
                <div className="col-span-1 text-right">
                  {editingRecruiterId === recruiter.id ? (
                    ...
                    <>
                      ...
                      {/* <button
    className="ml-4 rounded-full text-blue-500 hover:text-blue-600"
    onClick={() => handleEditClick(recruiter)}  // Trigger modal for deeper editing
  >
    <span className="sr-only">Edit in Modal</span>
    <svg
      className="h-8 w-8 fill-current"
      viewBox="0 0 32 32"
    >
