          ...
          <>
            ...
            <Form.Group controlId="formPassword">
              ...
              <div className="mt-2">
                <p
                  className={
                    passwordStrength.length ? "text-success" : "text-danger"
                  }
                >
                  • At least 8 characters
                </p>
                <p
                  className={
                    passwordStrength.uppercase ? "text-success" : "text-danger"
                  }
                >
                  • At least one uppercase letter (A-Z)
                </p>
                <p
                  className={
                    passwordStrength.lowercase ? "text-success" : "text-danger"
                  }
                >
                  • At least one lowercase letter (a-z)
                </p>
                <p
                  className={
                    passwordStrength.digit ? "text-success" : "text-danger"
                  }
                >
                  • At least one digit (0-9)
                </p>
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose} centered>
        <Modal.Header>
          <Modal.Title>
            Add Recruiter - Step {currentStep} of 4
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            ...
            <div className="d-flex justify-content-between">
              ...
              <Button
                onClick={handleNext}
                className="flex justify-center rounded bg-success px-6 py-2 font-medium text-gray hover:bg-opacity-90"
                disabled={currentStep === 4 && !isPasswordValid}
              >
